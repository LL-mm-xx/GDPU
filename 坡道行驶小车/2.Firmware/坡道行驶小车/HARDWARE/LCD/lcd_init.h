...
#define LCD_DC_Clr()   GPIO_ResetBits(GPIOB,GPIO_Pin_13)//DC
#define LCD_DC_Set()   GPIO_SetBits(GPIOB,GPIO_Pin_13)
 		     
#define LCD_CS_Clr()   GPIO_ResetBits(GPIOB,GPIO_Pin_14)//CS
#define LCD_CS_Set()   GPIO_SetBits(GPIOB,GPIO_Pin_14)

#define LCD_BLK_Clr()  GPIO_ResetBits(GPIOB,GPIO_Pin_15)//BLK
#define LCD_BLK_Set()  GPIO_SetBits(GPIOB,GPIO_Pin_15)

...
void Mode1_Select_Display(void)
{
     //´¥ÆÁ°´Å¥
    tp_dev.scan(0);
    if(10<tp_dev.x[0] && tp_dev.x[0]<74 && 10<tp_dev.y[0] && tp_dev.y[0]<35 && Start==0)//MODE1
    {
        switch(Switch_flag)
        {
            case 0:
    ...
    if(90<tp_dev.x[0] && tp_dev.x[0]<154 && 10<tp_dev.y[0] && tp_dev.y[0]<35 && Start==0)//MODE2
    {
        switch(Switch_flag)
        {
            case 0:
    ...
    if(170<tp_dev.x[0] && tp_dev.x[0]<234 && 10<tp_dev.y[0] && tp_dev.y[0]<35 && Start==0)//MODE3
    {
        switch(Switch_flag)
        {
            case 0:
    ...
    if(10<tp_dev.x[0] && tp_dev.x[0]<74 && 40<tp_dev.y[0] && tp_dev.y[0]<65 && Start==0)//MODE4
    {
        switch(Switch_flag)
        {
            case 0:
    ...
    if(90<tp_dev.x[0] && tp_dev.x[0]<154 && 40<tp_dev.y[0] && tp_dev.y[0]<65 && Start==0)//MODE5
    {
        switch(Switch_flag)
        {
            case 0:
    ...
    if(170<tp_dev.x[0] && tp_dev.x[0]<234 && 40<tp_dev.y[0] && tp_dev.y[0]<65 && Start==0)//MODE6
    {
        switch(Switch_flag)
        {
            case 0:
    ...
    if(170<tp_dev.x[0] && tp_dev.x[0]<234 && 100<tp_dev.y[0] && tp_dev.y[0]<125 && Start==0)//Negti
    {
         switch(Switch_flag)
        {
            case 0:
    ...
    Dis = Dis_Num[2]*100 + Dis_Num[1]*10 + Dis_Num[0]*1;
    temp1 = Ang_Num[2]*100 + Ang_Num[1]*10 + Ang_Num[0]*1;
